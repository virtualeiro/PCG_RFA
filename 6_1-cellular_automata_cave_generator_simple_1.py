...
WALL_PROBABILITY = 0.60 #0.45 #60% chance a cell starts as a wall
ITERATIONS = 5
...
#Note: Out-of-bounds = treated as walls
# ----------------------------
...
def simulation_step(grid):
    ...
    for x in range(COLS):
        ...
        for y in range(ROWS):
            ...
            # if a cell has 5 or more wall neighbors, it becomes a wall;
